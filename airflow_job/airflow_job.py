...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow_exercises")
    bq_project = Variable.get("bq_project", default_var="sodium-shard-467709-a5")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"airflow_exercises/airflow_project/source-{env}/flight_booking.csv",  # Full file path in GCS 
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflow_project/spark_code/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "757635853681-compute@developer.gserviceaccount.com",
                "network_uri": "projects/sodium-shard-467709-a5/global/networks/default",
                "subnetwork_uri": "projects/sodium-shard-467709-a5/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="sodium-shard-467709-a5",
        region="us-central1",
